...
type FiringMode = "Single" | "Burst" | "Auto";

type DamageType = "Ballistic" | "Explosive" | "Melee";

// All time related fields should be set in milliseconds
// Player health is out of 100.0
export interface WeaponStats {
    adsTime: number; // The time it takes to aim down sights when player is not sprinting
    ...
    fireRate: number; // The wait time between shots in milliseconds
    ...
    reloadTime: number; // The time it takes to reload the weapon in milliseconds
